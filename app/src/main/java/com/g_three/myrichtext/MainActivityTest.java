    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("html11111111111111111111111 = " + html);
            }
        });
...
*/
        ...
        mEditor.setOnTextChangeListener(new MyEdittor.OnTextChangeListener() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                //http://47.100.237.50:8080/wg/img/cnm.jpg
                //html += "\n" +"<img src=\"https://unsplash.it/2000/2000?random&58\" alt=\"Smiley face\" width=\"100%\" height=\"300px\">\n";
                //mEditor.insertImage("https://unsplash.it/2000/2000?random&58", "huangxiaoguo\" style=\"max-width:100%");
                //mEditor.insertImage(realPathFromUri, realPathFromUri + "\" style=\"max-width:100%");

                //System.out.println("真实路径--------------"+realPathFromUri);
                mEditor.insertMyImg("http://47.100.237.50:8080/wg/img/cnm.jpg","哈哈");
